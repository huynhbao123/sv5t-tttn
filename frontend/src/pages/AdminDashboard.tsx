                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center justify-end gap-3 w-full">
                      ...
                      <button onClick={async () => {
                        ...
                        setIsReviewing(true);
                      }} className="w-[125px] flex items-center justify-center py-2.5 bg-blue-900 text-white text-[9px] font-black uppercase tracking-widest rounded-lg hover:bg-orange-600 transition-all border border-blue-950 shadow-sm shrink-0">
                        <i className="fas fa-eye mr-1.5"></i>Thẩm định
                      </button>
                      
                      {/* Vùng chứa thùng rác có kích thước cố định để đẩy nút Thẩm định thằng hàng */}
