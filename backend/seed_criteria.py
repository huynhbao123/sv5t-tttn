...
SUB_CRITERIA_MAP = {
    ...
    'Tình nguyện tốt': [
        ...
        {'id': 'vol_hard_2', 'description': 'Tham gia ít nhất 03 ngày tình nguyện/năm', 'isHard': True},
        {'id': 'vol_hard_3', 'description': 'Giấy khen cấp Trường trở lên về tình nguyện', 'isHard': True},
        {'id': 'vol_hard_4', 'description': 'GCN Hiến máu nhân đạo (2 lần tại DUE hoặc 3 lần ngoài)', 'isHard': True},
