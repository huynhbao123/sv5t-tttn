...
EMAIL_TIMEOUT = int(os.getenv('EMAIL_TIMEOUT', '10'))  # 10s để tránh Render timeout
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@sv5t.edu.vn')

# ── Frontend URL (dùng cho link reset password) ───
